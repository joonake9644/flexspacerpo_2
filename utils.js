...
exports.requireEnv = exports.chunkArray = exports.debounce = exports.isValidPhoneNumber = exports.isValidEmail = exports.formatFileSize = exports.truncateText = exports.formatScheduleDays = exports.formatCurrency = exports.translateProgramLevel = exports.translateBookingStatus = exports.translateFirebaseError = exports.minutesToTimeString = exports.timeStringToMinutes = exports.dateToTimestamp = exports.formatFirebaseTimestamp = exports.formatPhoneNumberForDisplay = void 0;
exports.cn = cn;
// lib/utils.ts (정상화)
...
const formatFirebaseTimestamp = (timestamp, format = 'datetime') => {
    if (!timestamp)
        return '정보 없음';
...
exports.formatFirebaseTimestamp = formatFirebaseTimestamp;
// Date → Timestamp
const dateToTimestamp = (date) => firestore_1.Timestamp.fromDate(date);
...
exports.translateFirebaseError = translateFirebaseError;
// 예약 상태 번역
...
exports.translateBookingStatus = translateBookingStatus;
// 프로그램 레벨 번역
const translateProgramLevel = (level) => {
    const levelMap = {
        beginner: '초급',
        intermediate: '중급',
        advanced: '고급',
...
exports.translateProgramLevel = translateProgramLevel;
// 통화 포맷
...
exports.formatScheduleDays = formatScheduleDays;
// 말줄임
